        ...
        <nav class="navbar navbar-light navbar-expand-lg py-4">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="${pageContext.request.contextPath}/aboutUser" class="nav-item nav-link">About</a>
                    <a href="${pageContext.request.contextPath}/serviceUser" class="nav-item nav-link">Services</a>
                    <a href="${pageContext.request.contextPath}/eventUser" class="nav-item nav-link">Events</a>
                    <a href="${pageContext.request.contextPath}/menuUser" class="nav-item nav-link">Menu</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                        <div class="dropdown-menu bg-light">
                            <a href="${pageContext.request.contextPath}/bookingUser" class="dropdown-item">Booking</a>
                            <a href="${pageContext.request.contextPath}/blogUser" class="dropdown-item">Our Blog</a>
                            <a href="${pageContext.request.contextPath}/teamUser" class="dropdown-item">Our Team</a>
                            <a href="${pageContext.request.contextPath}/reviewUser" class="dropdown-item">Testimonial</a>
                        </div>
                    </div>
                    <a href="${pageContext.request.contextPath}/contactUser" class="nav-item nav-link">Contact</a>
                </div>
                <button class="btn-search btn btn-primary btn-md-square me-4 rounded-circle d-none d-lg-inline-flex" data-bs-toggle="modal" data-bs-target="#searchModal"><i class="fas fa-search"></i></button>
                <a href="${pageContext.request.contextPath}/profile" class="btn btn-primary py-2 px-4 d-none d-xl-inline-block rounded-pill">Your Profile</a>
            </div>
        </nav>
    </div>
</div>
